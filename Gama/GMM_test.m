...
filename = 'GC_m_CH_64_0_8k.csv';
filename1 = 'GC_f_CH_64_0_8k.csv';
% filename = 'GC_m_EN.csv';
% filename1 = 'GC_f_EN.csv';
% filename = 'GC_m_En.csv';
% filename1 = 'GC_f_En.csv';
...
[GMM_chinese.mu_m1,GMM_chinese.sigm_m1,GMM_chinese.c_m1]=gmm_estimate(sp_m(:,1:13)',M);
[GMM_chinese.mu_f1,GMM_chinese.sigm_f1,GMM_chinese.c_f1]=gmm_estimate(sp_f(:,1:13)',M);
...
% [GMM_English.mu_m1,GMM_English.sigm_m1,GMM_English.c_m1]=gmm_estimate(sp_m(:,1:13)',M);
% [GMM_English.mu_f1,GMM_English.sigm_f1,GMM_English.c_f1]=gmm_estimate(sp_f(:,1:13)',M);
